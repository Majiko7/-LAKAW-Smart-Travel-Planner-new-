...
class _HomePageWidgetState extends State<HomePageWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.allDestinations = await DestinationsTable().queryRows(
        queryFn: (q) => q,
      );
      _model.destinations =
          _model.allDestinations!.toList().cast<DestinationsRow>();
      safeSetState(() {});
    });
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Column(
                                      ...
                                      children: [
                                        ClipRRect(
                                          ...
                                          child: Image.asset(
                                            'assets/images/Asset_6@300x.png',
                                            height: 20.0,
                                            fit: BoxFit.contain,
                                          ),
                                        ),
                                    ...
                                    ClipRRect(
                                      ...
                                      child: Image.asset(
                                        'assets/images/Asset_8@300x.png',
                                        height: 50.0,
                                        fit: BoxFit.cover,
                                      ),
                                    ),
                                              ...
                                              InkWell(
                                                ...
                                                child: FlutterFlowIconButton(
                                                  ...
                                                  onPressed: () async {
                                                    ...
                                                    _model.searchedDestinations = _model
                                                        .destinations
                                                        .where((e) => _model
                                                            .simpleSearchResults
                                                            .contains(e.name))
                                          ...
                                          child: Builder(
                                            builder: (context) {
                                              ...
                                              return ListView.builder(
                                                ...
                                                itemCount:
                                                    destinationsRow.length,
                                                itemBuilder: (context,
                                                    destinationsRowIndex) {
                                                  final destinationsRowItem =
                                                      destinationsRow[
                                                          destinationsRowIndex];
                                                  return Padding(
                                                    padding:
