...
import 'saved_itinerary_model.dart';
export 'saved_itinerary_model.dart';
...
class _SavedItineraryWidgetState extends State<SavedItineraryWidget> {
  late SavedItineraryModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SavedItineraryModel());
