...
import 'travel_guide_model.dart';
export 'travel_guide_model.dart';

class TravelGuideWidget extends StatefulWidget {
  const TravelGuideWidget({
    super.key,
    required this.title,
  ...
  static String routeName = 'TravelGuide';
  static String routePath = '/travelGuide';

  @override
  State<TravelGuideWidget> createState() => _TravelGuideWidgetState();
}

class _TravelGuideWidgetState extends State<TravelGuideWidget> {
  late TravelGuideModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TravelGuideModel());
